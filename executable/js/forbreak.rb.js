...
(function(Opal) {
  ...
  var $a, $b, $c, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $range = Opal.range, j = nil, i = nil;

  Opal.add_stubs(['$each', '$==', '$+', '$puts']);
  j = 0;
  (function(){var $brk = Opal.new_brk(); try {return ($b = ($c = $range(1, 4, false)).$each, $b.$$p = (TMP_1 = function($a){var self = TMP_1.$$s || this;
if ($a == null) $a = nil;
  i = $a;
    if (i['$=='](4)) {
      
      Opal.brk(nil, $brk)};
    return j = $rb_plus(j, i);}, TMP_1.$$s = self, TMP_1.$$brk = $brk, TMP_1.$$arity = 1, TMP_1), $b).call($c)
