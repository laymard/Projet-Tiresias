...
/* Generated by Opal 0.10.3 */
(function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, n = nil;

  Opal.add_stubs(['$puts', '$new', '$meth']);
  (function($base, $super) {
    function $George(){};
    ...
    return (Opal.defn(self, '$meth', TMP_1 = function $$meth() {
      var self = this;

      return self.$puts("Walter White");
    }, TMP_1.$$arity = 0), nil) && 'meth'
  })($scope.base, null);
