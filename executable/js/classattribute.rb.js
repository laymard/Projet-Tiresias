...
/* Generated by Opal 0.10.3 */
(function(Opal) {
  var $a, $b, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, n = nil;

  Opal.add_stubs(['$attr_accessor', '$puts', '$new', '$name=', '$print_name']);
  (function($base, $super) {
    function $George(){};
    var self = $George = $klass($base, $super, 'George', $George);
    ...
    return (Opal.defn(self, '$print_name', TMP_1 = function $$print_name() {
      var self = this;

      return self.$puts("Hi " + (self.name));
    }, TMP_1.$$arity = 0), nil) && 'print_name';
  })($scope.base, null);
  n = $scope.get('George').$new();
  (($a = ["Walter White"]), $b = n, $b['$name='].apply($b, $a), $a[$a.length-1]);
  return n.$print_name();
})(Opal);
