...
(function(Opal) {
  ...
  Opal.add_stubs(['$<=', '$*', '$fact', '$-', '$puts']);
  Opal.defn(Opal.Object, '$fact', TMP_1 = function $$fact(n) {
    var $a, self = this;

    if ((($a = ($rb_le(n, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      return 1};
    return $rb_times(n, self.$fact($rb_minus(n, 1)));
  }, TMP_1.$$arity = 1);
  self.$puts(self.$fact(3));
  self.$puts(self.$fact(50));
  return self.$puts(self.$fact(0));
})(Opal);
